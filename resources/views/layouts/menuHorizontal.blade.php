                            ...
                            <a href="javascript:void(0);">
                                <div class="progress-container progress-primary">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        ...
                                        <li>
                                            <img src="/backend/images/xs/avatar2.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="/backend/images/xs/avatar3.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="/backend/images/xs/avatar4.jpg" alt="Avatar">
                                        </li>                            
                                    </ul>
                                </div>
                            </a>
                            ...
                            <a href="javascript:void(0);">
                                <div class="progress-container progress-info">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small class="text-muted">Team</small></li>
                                        <li>
                                            <img src="/backend/images/xs/avatar10.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="/backend/images/xs/avatar9.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="/backend/images/xs/avatar8.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="/backend/images/xs/avatar7.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="/backend/images/xs/avatar6.jpg" alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            </a>
                            ...
                            <a href="javascript:void(0);">
                                <div class="progress-container progress-warning">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small class="text-muted">Team</small></li>
                                        <li>
                                            <img src="/backend/images/xs/avatar5.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="/backend/images/xs/avatar2.jpg" alt="Avatar">
                                        </li>
...
<!-- menú derecha configuraciones Admin -->
            ...
            <div class="slim_scroll">
                <div class="card user_activity">
                    ...
                    <div class="streamline b-accent">
                        <div class="sl-item">
                            <img class="user rounded-circle" src="/backend/images/xs/avatar4.jpg" alt="">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="/backend/images/xs/avatar5.jpg" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="/backend/images/xs/avatar6.jpg" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="/backend/images/xs/avatar7.jpg" alt="">
                            <div class="sl-content">
