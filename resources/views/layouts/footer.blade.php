...
<footer id="page-footer">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4">
                    <aside>
                        <header><h4>Contactos</h4></header>
                        <address>
                            <strong>AulaOnline</strong>
                            <br>
                            <span>4877 Spruce Drive</span>
                            <br><br>
                            <span>West Newton, PA 15089</span>
                            <br>
                            <abbr title="Telephone">Telefono:</abbr> +1 (734) 123-4567
                            <br>
                            <abbr title="Email">Email:</abbr> <a href="#">info@aulaonline.com</a>
                        </address>
                    </aside>
                </div><!-- /.col-md-3 -->
                <div class="col-md-3 col-sm-4">
                    <aside>
                        <header><h4>Cursos Importantes</h4></header>
                        <ul class="list-links">
                ...
                <div class="col-md-3 col-sm-4">
                    <aside>
                        ...
                        <div>
                            <a href="" class="read-more">Nuevos</a>
                        </div>
                    </aside>
                </div><!-- /.col-md-3 -->
            </div><!-- /.row -->
    ...
    <section id="footer-bottom">
        <div class="container">
            <div class="footer-inner">
                <div class="copyright">©Aula Online, todos los derechos reservados</div><!-- /.copyright -->
            </div><!-- /.footer-inner -->
        </div><!-- /.container -->
